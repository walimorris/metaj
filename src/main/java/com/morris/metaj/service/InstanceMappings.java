...
@Service
public class InstanceMappings {
    private static final Logger logger = LoggerFactory.getLogger(InstanceMappings.class);

    public InstanceMappings() {}

    private Map<String, String> getBlockDeviceMappingsMap(String blockDeviceMapping) throws IOException {
